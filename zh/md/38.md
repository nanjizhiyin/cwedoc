...
<h5>弱点抽象</h5>变体
<h5>状态</h5>草案
<h5>描述</h5>在没有适当验证的情况下接受反斜杠绝对路径(‘绝对值“)形式的输入的软件系统可以允许攻击者遍历文件系统到意外位置或访问任意文件。
<h5>扩展描述</h5>空
