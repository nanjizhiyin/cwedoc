# ID: 148 - Improper Neutralization of Input Leaders
<h5>Name</h5>Improper Neutralization of Input Leaders
<h5>Weakness</h5>Variant
<h5>Status</h5>Draft
<h5>Description</h5>The application does not properly handle when a leading character or sequence (leader) is missing or malformed, or if multiple leaders are used when only one should be allowed.
